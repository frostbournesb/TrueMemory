...
- Neuromem Pro: 91.5% on LoCoMo
- Neuromem Base: 88.2% on LoCoMo
...
- Neuromem Pro: 91.5%, Neuromem Base: 88.2%
- All runs completed with zero API errors

## [0.1.3] - 2026-03-28

### Added
- NEUROMEM_EMBED_MODEL environment variable for tier selection
- GPU optional dependency (`pip install neuromem-core[gpu]`)
...
### Added
- Initial release of neuromem-core
