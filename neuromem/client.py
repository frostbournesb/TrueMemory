"""
Neuromem Client — Simple Memory API
====================================

A Mem0-compatible interface that wraps :class:`NeuromemEngine` for the
simplest possible developer experience::

    from neuromem import Memory

    m = Memory()                          # ~/.neuromem/memories.db
...
_DEFAULT_DB = Path.home() / ".neuromem" / "memories.db"
...
class Memory:
    ...
    Args:
        path: Database file path.  Defaults to ``~/.neuromem/memories.db``.
    ...
    def __init__(self, path: str | Path | None = None):
        ...
        self._engine = NeuromemEngine(db_path=db_path)
