"""
Neuromem L0 — Personality Engram
=================================
...
:func:`neuromem.storage.create_db`.  No external dependencies beyond the
...
from neuromem.fts_search import _build_safe_fts_query
...
def update_entity_profile_incremental(
    ...
    Called from :meth:`NeuromemEngine.add` so that profiles build up as
